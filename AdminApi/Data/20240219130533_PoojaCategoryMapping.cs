...
{
    public partial class PoojaCategoryMapping : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PoojaCategoryMappings",
                columns: table => new
                {
                    PoojaCategoryMappingId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TempleId = table.Column<int>(nullable: false),
                    PoojaCategoryId = table.Column<int>(nullable: false),
                    CreatedBy = table.Column<int>(nullable: false),
                    CreatedOn = table.Column<DateTime>(nullable: true, defaultValue: new DateTime(2024, 2, 19, 18, 35, 33, 23, DateTimeKind.Local).AddTicks(3913)),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PoojaCategoryMappings", x => x.PoojaCategoryMappingId);
                });
